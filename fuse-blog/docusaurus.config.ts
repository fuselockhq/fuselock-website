...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/fuselockhq/fuselock-website/tree/main/fuse-blog/docs',
        },
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/fuselockhq/fuselock-website/tree/main/fuse-blog/blog',
  ...
  themeConfig: {
    ...
    colorMode: {
      ...
      disableSwitch: true,           // Remove the toggle for switching modes
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/fuselockhq',
          label: 'GitHub',
          position: 'right',
        },
      ],
